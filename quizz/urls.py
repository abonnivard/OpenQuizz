...
from .views import interfaceProf0,interfaceProf1, resultat, interfaceUser, waitingpageUser0,waitingpageUser1, finQuizz,finQuizzProf, userAnswered,erreurPseudo,userAnswered_resultat
